                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="my_profile_setting_textarea">
                                                            ...
                                                            <textarea class="form-control" id="propertyDescription" rows="7" name="prop_description" value="{{$property->prop_description}}"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input ui_kit_select_search form-group">
                                                            <label>Type</label>
                                                            <select class="selectpicker" data-live-search="true" data-width="100%" name="prop_type" value="{{$property->prop_type}}">
                                                                <option {{$property->prop_type == 'Bungalow' ? 'selected' : ''}} value="Bungalow">Bungalow</option>
                                                                <option {{$property->prop_type == 'Duplex' ? 'selected' : ''}} value="Duplex">Duplex</option>
                                                                <option {{$property->prop_type == 'Semi-detached' ? 'seclected' : ''}} value="Semi-detached">Semi-detached Duplex</option>
                                                                <option {{$property->prop_type == 'SkyCraper' ? 'selceted' : ''}} value="SkyCraper">SkyCraper</option>
                                                                <option {{$property->prop_type == 'Mansion' ? 'selected' : ''}} value="Mansion">Mansion</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input ui_kit_select_search form-group">
                                                            ...
                                                            <select class="selectpicker" data-live-search="true" data-width="100%" name="status" value="{{old('status')}}">
                                                                ...
                                                                <option {{$property->status == 'Lease' ? 'selected' : ''}} value="Lease">Lease</option>
