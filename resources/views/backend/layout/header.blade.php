    ...
    <div class="container-fluid p0">
        ...
        <nav>
            ...
            <div class="menu-toggle">
                <img class="nav_logo_img img-fluid" src="{{asset('frontend/images/header-logo.png')}}" alt="header-logo.png">
            ...
            <a href="#" class="navbar_brand float-left dn-smd">
                <img class="logo1 img-fluid" src="{{asset('frontend/images/header-logo2.png')}}" alt="header-logo.png">
                <img class="logo2 img-fluid" src="{{asset('frontend/images/header-logo2.png')}}" alt="header-logo2.png">
                <span>FindHouse</span>
            </a>
            ...
            <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
                ...
                <li>
                    <a href="{{route('properties')}}"><span class="title">Properties</span></a>
                </li>
        ...
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-center">
                    <img class="nav_logo_img img-fluid mt20" src="{{asset('frontend/images/header-logo2.png')}}" alt="header-logo2.png">
