                ...
                <div class="col-lg-8">
                    <div class="main_blog_post_content">
                        <div class="mbp_thumb_post">
                            ...
                            <div class="thumb">
                                <img class="img-fluid" src="{{asset('frontend/images/blog/bs1.jpg')}}" alt="bs1.jpg">
                            </div>
                            <div class="details">
                        ...
                        <div class="product_single_content mb30">
                            <div class="mbp_pagination_comments">
                                ...
                                <div class="mbp_first media">
                                    <img src="{{asset('frontend/images/testimonial/1.pn')}}" class="mr-3" alt="1.png">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="for_blog feat_property">
                                <div class="thumb">
                                    <img class="img-whp" src="{{asset('frontend/images/blog/1.jpg')}}" alt="1.jpg">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="for_blog feat_property">
                                <div class="thumb">
                                    <img class="img-whp" src="{{asset('frontend/images/blog/2.jpg')}}" alt="2.jpg">
                                    <div class="tag">Construction</div>
                                </div>
                                <div class="details">
                                    <div class="tc_content">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="main_blog_post_content">
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{asset('frontend/images/blog/7.jpg')}}" alt="7.jpg">
                        ...
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{asset('frontend/images/blog/8.jpg')}}" alt="8.jpg">
                                <div class="blog_tag">Construction</div>
                            </div>
                            <div class="details">
                                <div class="tc_content">
                        ...
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{asset('frontend/images/blog/9.jpg')}}" alt="9.jpg">
                                <div class="blog_tag">Construction</div>
                            </div>
                            <div class="details">
                                <div class="tc_content">
