                    ...
                    <div class="row">
                                ...
                                <div class="property_video p0">
                                    <div class="thumb">
                                        ...
                                        <div class="overlay_icon">
                                            <a href="#"><img class="map_img_icon" src="{{asset('frontend/images/header-logo.png')}}" alt="header-logo.png"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card floor_plan">
                                            ...
                                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
                                                <div class="card-body text-center">
                                                    <img class="img-fluid" src="{{asset('frontend/images/resource/floor_plan.png')}}" alt="floor_plan.png">
                                ...
                                <div class="tab-content" id="myTabContent2">
                                    <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                        <div class="property_video">
                                            <div class="thumb">
                                                <img class="pro_img img-fluid w100" src="{{asset('frontend/images/background/7.jpg')}}" alt="7.jpg">
                                                <div class="overlay_icon">
                        ...
                        <div class="col-lg-12">
                            <div class="walkscore_area mt30">
                                <h4 class="mb30">Walkscore <span class="float-right"><img src="{{asset('frontend/images/resource/wscore.png')}}" alt="wscore.png"></span></h4>
                            ...
                            <div class="product_single_content">
                                <div class="mbp_pagination_comments mt30">
                                    ...
                                    <div class="mbp_first media">
                                        <img src="{{asset('frontend/images/testimonial/1.png')}}" class="mr-3" alt="1.png">
                                    ...
                                    <div class="mbp_first media">
                                        <img src="{{asset('frontend/images/testimonial/2.png')}}" class="mr-3" alt="2.png">
                                        <div class="media-body">
                        ...
                        <div class="col-lg-6">
                            <div class="feat_property">
                                <div class="thumb">
                                    <img class="img-whp" src="{{asset('frontend/images/property/fp2.jpg')}}" alt="fp2.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="tag mb0">
                                            <li class="list-inline-item"><a href="#">For Rent</a></li>
                                        </ul>
                        ...
                        <div class="col-lg-6">
                            <div class="feat_property">
                                <div class="thumb">
                                    <img class="img-whp" src="{{asset('frontend/images/property/fp3.jpg')}}" alt="fp3.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="tag mb0">
                    ...
                    <div class="sidebar_listing_list">
                        <div class="sidebar_advanced_search_widget">
                            <div class="sl_creator">
                                ...
                                <div class="media">
                                    <img class="mr-3" src="{{asset('frontend/images/team/lc1.png')}}" alt="lc1.png">
                                    <div class="media-body">
